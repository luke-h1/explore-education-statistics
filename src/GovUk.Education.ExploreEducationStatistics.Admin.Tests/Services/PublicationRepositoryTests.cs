...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Tests.Services
{
    public class PublicationRepositoryTests
    {
        ...
        [Fact]
        public async Task ListPublicationsForTopic()
        {
            ...
            await using (var contentDbContext = InMemoryApplicationDbContext(contentDbContextId))
            {
                ...
                var publications = await publicationService
                    .ListPublicationsForTopic(topic1.Id)
                    .ToListAsync();
        ...
        [Fact]
        public async Task ListPublicationsForTopic_NoTopic()
        {
            var topic1 = new Topic
            {
                Title = "Topic 1",
