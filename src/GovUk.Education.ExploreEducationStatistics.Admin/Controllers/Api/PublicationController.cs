...
namespace GovUk.Education.ExploreEducationStatistics.Admin.Controllers.Api
{
    ...
    public class PublicationController : ControllerBase
    {
        ...
        [HttpGet("publication/{publicationId:guid}/external-methodology")]
        public async Task<ActionResult<ExternalMethodology>> GetExternalMethodology(Guid publicationId)
        {
