...
namespace GovUk.Education.ExploreEducationStatistics.Data.Api.Controllers
{
    ...
    public class PublicationController : ControllerBase
    {
        ...
        {
            return _contentPersistenceHelper.CheckEntityExists<Publication>(publicationId).OnSuccess(publication =>
                publication.LatestPublishedReleaseId ?? new Either<ActionResult, Guid>(new NotFoundResult()));
        }
