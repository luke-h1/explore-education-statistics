...
namespace GovUk.Education.ExploreEducationStatistics.Data.Api.Controllers
{
    ...
    public class TableBuilderMetaController : ControllerBase
    {
        ...
        {
            return _releaseSubjectService.CheckReleaseSubjectExists(subjectId)
        ...
        {
            return _releaseSubjectService.CheckReleaseSubjectExists(releaseId: releaseId, subjectId: subjectId)
                .OnSuccess(GetCacheableReleaseSubject)
                .OnSuccess(GetSubjectMeta)
                .HandleFailuresOrOk();
        }
