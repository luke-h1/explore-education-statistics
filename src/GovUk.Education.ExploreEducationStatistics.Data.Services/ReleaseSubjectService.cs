...
public class ReleaseSubjectService : IReleaseSubjectService
{
    ...
    public async Task<Either<ActionResult, ReleaseSubject>> CheckReleaseSubjectExists(Guid subjectId)
    {
        return await CheckReleaseSubjectExists(subjectId, null);
    }

    public async Task<Either<ActionResult, ReleaseSubject>> CheckReleaseSubjectExists(Guid subjectId, Guid? releaseId)
    {
        return await (
                releaseId.HasValue
                    ...
                    : GetReleaseSubjectForLatestPublishedVersion(subjectId)
            )
            .OrNotFound();
    }
