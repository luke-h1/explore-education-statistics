...
namespace GovUk.Education.ExploreEducationStatistics.Data.Services
{
    public class SubjectMetaService : ISubjectMetaService
    {
        ...
        {
            return await _releaseSubjectService.CheckReleaseSubjectExists(subjectId: subjectId, releaseId: releaseId)
        ...
        {
            return await _releaseSubjectService.CheckReleaseSubjectExists(subjectId: query.SubjectId, releaseId: releaseId)
