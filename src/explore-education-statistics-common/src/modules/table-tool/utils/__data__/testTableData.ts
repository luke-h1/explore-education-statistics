...
export const testTableWithOneRowGroupHeaderSubGroup: FullTable = {
  subjectMeta: {
    ...initialTableSubjectMeta,
    filters: {
      Category1: {
...
export const testTableWithOneRowGroupHeaderSubGroupConfig: TableHeadersConfig = {
  columns: [location1, location2],
  columnGroups: [],
  rows: [category2Filter1, category2Filter2],
  rowGroups: [[indicator1], [timePeriod1]],
};
